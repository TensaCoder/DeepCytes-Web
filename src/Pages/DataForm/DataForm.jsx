...
function DataForm() {
  ...
  return (
    <>
      <div className="container my-5 bg-dark text-light d-flex justify-content-center w-50">
        <form onSubmit={handleSubmit} className="w-75">
          <div className="form-row">
            ...
            <div className="form-group my-3">
              <label htmlFor="inputName" className="ms-1">Name</label>
              <input
                type="text"
                className="form-control"
                id="inputName"
          ...
          <div className="form-row my-3">
            <div className="form-group my-3">
              <label htmlFor="inputDOB" className="ms-1">Date of Birth</label>
              <input
                type="date"
                className="form-control"
                id="inputDOB"
            ...
            <div className="form-group my-3">
              <label htmlFor="inputInvolvement" className="ms-1">Involvement</label>
              <select
                id="inputInvolvement"
                className="form-control"
                value={involvement}
          ...
          <div className="form-group my-3">
            <label htmlFor="inputCourses" className="ms-1">Courses Completed</label>
          ...
          <div className="form-row my-3">
            ...
            <div className="form-group my-3">
              <label htmlFor="inputEmploymentAreas" className="ms-1">
                Employment Areas and Duration
              </label>
              <MultiValueInput
                placeholder="Area and Duration"
          ...
          <div className="form-group my-3">
            <label htmlFor="inputRecommendations" className="ms-1">Recommendations</label>
            <textarea
              className="form-control"
